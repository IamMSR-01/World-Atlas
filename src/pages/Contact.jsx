...
function Contact() {
  return (
    <div>
      ...
      <div className='flex justify-center align-middle mt-10 w-[350px] sm:w-[400px] mx-auto h-[60vh] bg-slate-300 rounded-xl bg-opacity-20 lg:w-[500px] lg:h-[70vh] 2xl:w-[600px] 2xl:h-[80vh]'>
      <form className='w-full h-full flex flex-col gap-5 p-5 border' action="onSubmit" method="post">
        ...
        <textarea 
        rows={10}
        className='w-full p-3 border 2xl:h-96 placeholder:text-white bg-opacity-20'
        required autoComplete='off'
        type="text"
